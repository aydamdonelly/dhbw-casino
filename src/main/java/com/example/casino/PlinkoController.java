...
import com.example.casino.model.plinkoModel.BinaryTree;
import com.example.casino.model.InsufficientFundsException;
import com.example.casino.model.plinkoModel.Tree;
import com.example.casino.model.plinkoModel.plinkoLogik;
    ...
    try {
            ...
            startThread = new Thread(() -> {
               ...
               plinkoLogik.spawnBall(convertInput(betAmount.getText()) , init());
                ...
                tList.stream().forEach(t->{Platform.runLater(()-> {
               ...
               /* for (Tree t: tList){
                ...
                logik.endGame();
                logik.player.controller.unblockButtonsTop();
            }
           );
